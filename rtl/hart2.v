...
`endif
    ...
    //
    // Stall when instruction in decode reads a register whose value
    // will be written by an older instruction still in EX or MEM.
    //
    // Since the regfile is written in WB, decode may proceed when the
    // producer reaches WB; therefore we do NOT stall on MEM/WB here.
    // ============================================================
    ...
    // - flush: kill wrong-path instruction
    // - stall: hold current instruction in decode
    // ============================================================
    ...
    // - flush or stall: inject bubble into EX
    // ============================================================
    ...
    fetch #(
        ...
        .i_clk(i_clk),
        .i_rst(i_rst),
        .i_stall(hazard_stall),                         // <--- stall fetch on data hazard
